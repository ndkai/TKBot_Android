package com.example.iot_app.ui.bluetooth.ble.operation;
                                        ...
                                        public void onReadSuccess(final byte[] data) {
                                            runOnUiThread(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    Log.d("TAGTAG", " characteristic.getService().getUuid().toString(): "+ characteristic.getService().getUuid().toString());
                                                    Log.d("TAGTAG", "characteristic.getUuid().toString(): "+characteristic.getUuid().toString());
                                                }
                                            });
                                        }
