'use strict';
       ...
       //temperature
        Blockly.JavaScript['temperature_tit'] = function(block) {
          ...
          var dropdown_tem_slot = block.getFieldValue('tem_slot');
          // TODO: Assemble JavaScript into code variable.
          var code ="Turtle.temperature(\'"+dropdown_tem_port+"\',\'"+ dropdown_tem_slot +"\')";
          return [code, Blockly.JavaScript.ORDER_NONE];
        };
      ...
      Blockly.JavaScript['servo_tit'] = function(block) {
        ...
        var dropdown_servo_slot = block.getFieldValue('servo_slot');
        var number_servo_angle = block.getFieldValue('servo_angle');
        // TODO: Assemble JavaScript into code variable.
        var code = "Turtle.servo(\'"+dropdown_servo_port+"\',\'"+dropdown_servo_slot+"\',"+number_servo_angle+");\n";
        return code;
      };
